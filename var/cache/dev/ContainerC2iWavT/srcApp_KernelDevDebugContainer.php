...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getTokenSendlerService()
    {
        ...
        return $this->privates['App\\Services\\TokenSendler'] = new \App\Services\TokenSendler(($this->services['swiftmailer.mailer.default'] ?? $this->getSwiftmailer_Mailer_DefaultService()), ($this->services['twig'] ?? $this->getTwigService()));
    }

...
class __TwigTemplate_f168fba6381fe1e6e2cf09a9c32d79f72426e801882dfe84c388bc0708caae93 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "            <tr>
                <td>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "catId", [], "any", false, false, false, 19), "html", null, true);
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "catLibelle", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categories_show", ["cat_id" => twig_get_attribute($this->env, $this->source, $context["category"], "cat_id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("categories_edit", ["cat_id" => twig_get_attribute($this->env, $this->source, $context["category"], "cat_id", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <table class=\"table\">
        ...
        {% for category in categories %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('categories_show', {'cat_id': category.cat_id}) }}\">show</a>
...
{% endblock %}
", "categories/index.html.twig", "C:\\wamp64\\www\\filrougeAFPA\\templates\\categories\\index.html.twig");
    }
}

...
class __TwigTemplate_8b144d8c6ca7ce167c59186868b5228ad8b193bff9bb99cd55666c4ceae793ae extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            ...
            echo "            <tr>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["group"], "groupId", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["group"], "groupName", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["group"], "groupDescr", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("group_show", ["group_id" => twig_get_attribute($this->env, $this->source, $context["group"], "group_id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\"><i class=\"fas fa-eye\"></i></a>&nbsp;&nbsp;
                    <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("group_edit", ["group_id" => twig_get_attribute($this->env, $this->source, $context["group"], "group_id", [], "any", false, false, false, 25)]), "html", null, true);
    ...
    <table class=\"table\">
        ...
        {% for group in groups %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('group_show', {'group_id': group.group_id}) }}\"><i class=\"fas fa-eye\"></i></a>&nbsp;&nbsp;
                    <a href=\"{{ path('group_edit', {'group_id': group.group_id}) }}\"><i class=\"fas fa-edit\"></i></a>
                </td>
            </tr>
        {% else %}
            <tr>
